            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img src="<%=request.getContextPath()%>/views/images/${productUpdate.productImage}" alt="Ảnh sản phẩm" width="100" height="100"/>
                        <input type="hidden" name="oldImage" value="${productUpdate.productImage}"/>
                    </td>
                </tr>
                <tr>
                    <td>Discription</td>
                    <td><textarea name="description" id="description">${productUpdate.discription}</textarea></td>
                    ...
                    <td>
                        <select id="productId" name="catalogId">
                            <c:forEach items="${listCat}" var="cat">
                                <option value="${cat.catalogId}" checked="${cat.catalogId==productUpdate.catalogId?'checked':''}">${cat.catalogName}</option>
                            </c:forEach>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td> Status</td>
                    <td>
                        <input type="radio" name="status" id="active" value="true" checked="${productUpdate.productStatus?'checked':''}"/><label for="active">Active</label>
                        <input type="radio" name="status" id="inactive" value="false" checked="${productUpdate.productStatus?'':'checked'}"/><label for="inactive">Inactive</label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2"> <input type="submit" value="Update" name="action"/>
                    </td>
                </tr>
            </table>
        </form>
