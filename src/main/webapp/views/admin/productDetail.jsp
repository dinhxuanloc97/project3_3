        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-5">
                    <img style="width: 450px" src="<%=request.getContextPath()%>views/images/${pro.productImage} "/>
                </div>
                <div class="col-md6-6 col-lg-7">
                    <div class="detail-box">
                        <div class="heading-container">
                            <p> Name : ${pro.productName}</p>
                            <p> Price : ${pro.price} $ </p>
                            <p> Quantity : ${pro.quantity}</p>
                            <p> Title : ${pro.discription}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row text-muted">
                    <div class="col-6 text-start">
                        <p class="mb-0">
                            <a class="text-muted" href="" target="_blank"><strong>Apple Wactch</strong></a>
                            - <a class="text-muted" href="" target="_blank"><strong>Đồng Hành Trong Mọi Khoảnh Khắc
                            </strong></a> &copy;
                        </p>
                    </div>
