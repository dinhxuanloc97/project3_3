...
<div class="hero-wrap hero-bread" style="background-image: url('<%=request.getContextPath()%>/views/images/anh_27.jpeg');">
    <div class="container">
...
<section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<%=request.getContextPath()%>/views/images/anh_6.jpeg);">
...
<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(<%=request.getContextPath()%>/views/images/anh_24.jpeg);">
    <div class="container">
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate text-center">
                ...
                <h2 class="mb-4">Phản Hồi khách hàng đã trải nghiệm Apple Wacth</h2>

                <!-- <p> away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in</p> -->
            </div>
        </div>
                ...
                <div class="carousel-testimony owl-carousel">
                    ...
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                            ...
                            <div class="text text-center">
                                <p class="mb-5 pl-4 line">Sẽ là một trải nghiệm thú vị khi sử dụng Apple Wacth</p>
                                <p class="name">Tiệp Đặng </p>
                    ...
                    <div class="item">
                        <div class="testimony-wrap p-4 pb-5">
                            <div class="user-img mb-5" style="background-image: url(<%=request.getContextPath()%>/views/images/khminh.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                            </div>
