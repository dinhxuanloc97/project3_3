...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="index.jsp">  ToKe 97 </a>
...
<%--                </li>--%>
                ...
                <li class="nav-item "><a href="wishlist.jsp" class="nav-link">
                ...
                <li  class="nav-item cta cta-colored"><a href="cart.jsp" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown04">
                        ...
                        <a class="dropdown-item" href="regiter.jsp">Regiter</a>
                    </div>
                </li>
                ...
                <input placeholder="Search" type="text"></a>
